...
const ARTIFACT_QUERY_MAP: Record<string, { queryName: string; field: string; fields: string; gqlFields: string }> = {
  RestApi: {
    ...
    gqlFields: 'name, context, version, state, tracing, statistics, carbonApp, url, resources { path, methods }',
  },
  ProxyService: { queryName: 'proxyServicesByEnvironmentAndComponent', field: 'proxyServicesByEnvironmentAndComponent', fields: 'name, state', gqlFields: 'name, state, tracing, statistics, carbonApp, endpoints' },
  ...
  InboundEndpoint: {
    ...
    gqlFields: 'name, protocol, sequence, onError, state, tracing, statistics, carbonApp',
  },
  ...
  Task: { queryName: 'tasksByEnvironmentAndComponent', field: 'tasksByEnvironmentAndComponent', fields: 'name, group, state', gqlFields: 'name, group, state, carbonApp' },
