...
import { rootUrl, loginUrl, orgUrl, newProjectUrl, projectUrl, componentUrl, projectLogsUrl, componentLogsUrl, environmentsUrl, newEnvironmentUrl, oidcCallbackUrl, newComponentUrl } from '../paths';
...
const routes: AppRoute[] = [
  ...
  { path: oidcCallbackUrl(), element: <OIDCCallback /> },
  {
    ...
    children: [
      ...
      { path: newComponentUrl(':orgHandler', ':projectId'), element: <CreateComponent /> },
