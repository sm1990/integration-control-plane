...
import { toVisibilityLabel, toVisibilityWire } from './_visibility';

describe('endpoint visibility mapping', () => {
  it('maps every label the endpoint editor offers to a wire value', () => {
